// src/lib.rs
/*
 * Core library for CryptoGateway
 */
...
#[derive(Debug)]
pub struct CryptoGatewayProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoGatewayProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoGateway processing");
    
    let mut processor = CryptoGatewayProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoGatewayProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoGatewayProcessor::new(false);
